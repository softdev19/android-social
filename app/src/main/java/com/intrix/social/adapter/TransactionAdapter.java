 ...
 */
public class TransactionAdapter extends ArrayAdapter<TransactionAdapter.TransactionInfo> {

    public TransactionAdapter(Context context, List<Transactions> data) {
